...
| [`rsshogi.sazpack`](sazpack.md) | `SazGame`, `SazPosition`, `SazPolicyEntry`, `SazWdl`, `write_sazpack()`, `decode_sazpack()` | SAZ2 自己対局教師データ |
...
from rsshogi.sazpack import write_sazpack, write_sazpack_file, decode_sazpack, decode_sazpack_file
...
| クラス | 説明 |
|------|------|
| [SazGame](sazpack.md#sazgame) | SAZ2 の 1 局分の初期局面・結果・手順 |
| [SazPosition](sazpack.md#sazposition) | 1 手分の自己対局データ |
| [SazPolicyEntry](sazpack.md#sazpolicyentry) | policy 候補手の確率と訪問数 |
| [SazWdl](sazpack.md#sazwdl) | win/draw/loss 分布 |
...
| `write_sazpack(games)` / `decode_sazpack(data)` | `rsshogi.sazpack` | SAZ2 バイナリの書き込みと読み込み |
